...
## D2 Creation of Worksheets

### D2.1 Creation of Overview Worksheet

**D2.1.1 Pull Longitude, Latitude and Country onto workspace**<br>
...
```{r pressure26, echo=FALSE, fig.cap="Bring Country, Latitude (generated) and Longitude (generated) into workspace", out.width = '100%'}
knitr::include_graphics("D2_1_1a.png")
```
...
```{r pressure27, echo=FALSE, fig.cap="Bring Event Type to Colour panel", out.width = '100%'}
knitr::include_graphics("D2_1_2a.png")
```

Change Measure of Event Type to Count as shown below.

```{r pressure28, echo=FALSE, fig.cap="Change Measure of Event Type to Count", out.width = '100%'}
knitr::include_graphics("D2_1_2b.png")
```

Now the countries are coloured based on the number of events (Count) that occurred in as shown below.

```{r pressure29, echo=FALSE, fig.cap="Countries coloured based on number of events", out.width = '100%'}
knitr::include_graphics("D2_1_2c.png")
```
...
```{r pressure30, echo=FALSE, fig.cap="Create filter for Event Type", out.width = '100%'}
knitr::include_graphics("D2_1_2d.png")
```

Select all the event types in the dialog box that appears.

```{r pressure31, echo=FALSE, fig.cap="Select all event types", out.width = '100%'}
knitr::include_graphics("D2_1_2e.png")
```

Select “Show Filter” for filter to appear on the right for users to select Event Types.

```{r pressure32, echo=FALSE, fig.cap="Select Show Filter", out.width = '100%'}
knitr::include_graphics("D2_1_2f.png")
```
...
```{r pressure35, echo=FALSE, fig.cap="Edit Colours", out.width = '100%'}
knitr::include_graphics("D2_1_2g.png")
```

Edit the title of the Legend as shown below.

```{r pressure36, echo=FALSE, fig.cap="Edit Legend Title", out.width = '100%'}
knitr::include_graphics("D2_1_2h.png")
```

Pull Country to Label panel to label the countries on the map.

```{r pressure33, echo=FALSE, fig.cap="Pull Country to Label panel", out.width = '100%'}
knitr::include_graphics("D2_1_2i.png")
```
...
```{r pressure34, echo=FALSE, fig.cap="Overview by Demonstration Events", out.width = '100%'}
knitr::include_graphics("D2_1_2j.png")
```

```{r pressure37, echo=FALSE, fig.cap="Overview by Violent Events", out.width = '100%'}
knitr::include_graphics("D2_1_2k.png")
```

**D2.1.3 Creation of Tooltip to provide more details for each country during mouse over.**<br>
...
```{r pressure38, echo=FALSE, fig.cap="Create bar charts for Event Types", out.width = '100%'}
knitr::include_graphics("D2_1_3a.png")
```
...
```{r pressure39, echo=FALSE, fig.cap="Colour bar charts by Event Types", out.width = '100%'}
knitr::include_graphics("D2_1_3b.png")
```

Double click on the colour squares in the legend on the right to change colours of the bars.

```{r pressure40, echo=FALSE, fig.cap="Assign similar colours to event types of the same categories", out.width = '100%'}
knitr::include_graphics("D2_1_3c.png")
```

Right click on Event Type to hide field label.

```{r pressure41, echo=FALSE, fig.cap="Hide Event Type label", out.width = '100%'}
knitr::include_graphics("D2_1_3d.png")
```

Change horizontal axis label by double clicking on the “Count of Event Type”.

```{r pressure42, echo=FALSE, fig.cap="Change horizontal axis label", out.width = '100%'}
knitr::include_graphics("D2_1_3e.png")
```

Double Click on the title of the chart to edit the title.

```{r pressure43, echo=FALSE, fig.cap="Update chart title", out.width = '100%'}
knitr::include_graphics("D2_1_3f.png")
```

Add data labels to the bar chart by double clicking on the bars and under Mark Label, select “Always Show” as follows.

```{r pressure44, echo=FALSE, fig.cap="Update settings to always show data labels", out.width = '100%'}
knitr::include_graphics("D2_1_3g.png")
```
...
```{r pressure45, echo=FALSE, fig.cap="Insert the created bar charts as part of Tooltip on the Overview sheet", out.width = '100%'}
knitr::include_graphics("D2_1_3h.png")
```

```{r pressure46, echo=FALSE, fig.cap="After inserting the worksheet into Tooltip", out.width = '100%'}
knitr::include_graphics("D2_1_3i.png")
```

The following is the resulting display when the mouse is brought over each country.

```{r pressure47, echo=FALSE, fig.cap="Tooltip provides country info when moused-over", out.width = '100%'}
knitr::include_graphics("D2_1_3j.png")
```
...
```{r pressure48, echo=FALSE, fig.cap="Re-size bar chart to ensure fit in Tooltip window", out.width = '100%'}
knitr::include_graphics("D2_1_3k.png")
```

The dimension of the Tooltip window is also edited to allow a larger Tooltip to be displayed.

```{r pressure49, echo=FALSE, fig.cap="Edit size of bar chart to fit in Tooltip window", out.width = '100%'}
knitr::include_graphics("D2_1_3l.png")
```

Update the title of the Overview by double-clicking on the title.

```{r pressure50, echo=FALSE, fig.cap="Updated title of Overview worksheet", out.width = '100%'}
knitr::include_graphics("D2_1_3m.png")
```

**D2.1.4 Insertion of filter for Year**<br>

Pull Year into the Filters pane as shown and select Year in the resulting Filter Field window that appears.

```{r pressure51, echo=FALSE, fig.cap="Create Year filter", out.width = '100%'}
knitr::include_graphics("D2_1_3n.png")
```

```{r pressure52, echo=FALSE, fig.cap="Select Years to be displayed", out.width = '100%'}
knitr::include_graphics("D2_1_3o.png")
```

In the following window, select the relevant years that we are interested in – 2015 to 2020.

```{r pressure53, echo=FALSE, fig.cap="Select Years 2015 to 2020", out.width = '100%'}
knitr::include_graphics("D2_1_3p.png")
```
...
```{r pressure54, echo=FALSE, fig.cap="Resulting display", out.width = '100%'}
knitr::include_graphics("D2_1_3q.png")
```

### D2.2 Creation of Detailed Worksheet
...
```{r pressure55, echo=FALSE, fig.cap="Pull Event Id Cnty, Latitude and Longitude in workspace", out.width = '100%'}
knitr::include_graphics("D2_2_1a.png")
```

Pull Event Type onto the Colour panel to get the following screen.

```{r pressure56, echo=FALSE, fig.cap="Colour by Event Type", out.width = '100%'}
knitr::include_graphics("D2_2_1b.png")
```
...
```{r pressure57, echo=FALSE, fig.cap="Create Event Type filter", out.width = '100%'}
knitr::include_graphics("D2_2_2a.png")
```

Select all in the Filter window that appears.

```{r pressure58, echo=FALSE, fig.cap="Create Event Type filter", out.width = '100%'}
knitr::include_graphics("D2_2_2b.png")
```

Select "Show Filters" at the Event Type in the Filters panel.

```{r pressure59, echo=FALSE, fig.cap="Show Event Type filter", out.width = '100%'}
knitr::include_graphics("D2_2_2c.png")
```
...
```{r pressure60, echo=FALSE, fig.cap="Create Country filter", out.width = '100%'}
knitr::include_graphics("D2_2_3a.png")
```

Select all the countries.

```{r pressure61, echo=FALSE, fig.cap="Select all countries", out.width = '100%'}
knitr::include_graphics("D2_2_3b.png")
```

Select Show Filter in the Filters panel for Country.

```{r pressure62, echo=FALSE, fig.cap="Show Country filter", out.width = '100%'}
knitr::include_graphics("D2_2_3c.png")
```
...
```{r pressure63, echo=FALSE, fig.cap="Show Country filter", out.width = '100%'}
knitr::include_graphics("D2_2_3d.png")
```
...
```{r pressure64, echo=FALSE, fig.cap="Pull Country onto workspace", out.width = '100%'}
knitr::include_graphics("D2_2_4a.png")
```

The result is a point representing the Country location.

```{r pressure65, echo=FALSE, fig.cap="Blue dot represents Country location", out.width = '100%'}
knitr::include_graphics("D2_2_4b.png")
```

In the Country panel, change Marks type from Automatic to Map as shown.

```{r pressure66, echo=FALSE, fig.cap="Change Marks type to Map", out.width = '100%'}
knitr::include_graphics("D2_2_4c.png")
```

The following is the resulting display.

```{r pressure67, echo=FALSE, fig.cap="Shaded region represents Country area", out.width = '100%'}
knitr::include_graphics("D2_2_4d.png")
```
...
```{r pressure68, echo=FALSE, fig.cap="Resulting display where country selected is highlighted", out.width = '100%'}
knitr::include_graphics("D2_2_4e.png")
```
...
```{r pressure69, echo=FALSE, fig.cap="Pull Country to details panel", out.width = '100%'}
knitr::include_graphics("D2_2_4f.png")
```

```{r pressure70, echo=FALSE, fig.cap="Remove colour by Country", out.width = '100%'}
knitr::include_graphics("D2_2_4g.png")
```

Click on the Colour panel to edit the colour of the highlight.

```{r pressure71, echo=FALSE, fig.cap="Edit colour of Country highlight", out.width = '100%'}
knitr::include_graphics("D2_2_4h.png")
```
...
```{r pressure72, echo=FALSE, fig.cap="Resulting display", out.width = '100%'}
knitr::include_graphics("D2_2_4i.png")
```
...
```{r pressure73, echo=FALSE, fig.cap="Pull Year to Pages", out.width = '100%'}
knitr::include_graphics("D2_2_5a.png")
```
...
```{r pressure74, echo=FALSE, fig.cap="Use tool on the right to select year or to play slideshow", out.width = '100%'}
knitr::include_graphics("D2_2_5b.png")
```
...
```{r pressure75, echo=FALSE, fig.cap="Select Circle in the Marks drop down list", out.width = '100%'}
knitr::include_graphics("D2_2_6a.png")
```
...
```{r pressure76, echo=FALSE, fig.cap="Select Circle colour and border", out.width = '100%'}
knitr::include_graphics("D2_2_6b.png")
```
