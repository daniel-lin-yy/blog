...
```{r pressure32, echo=FALSE, fig.cap="Edit Colours", out.width = '100%'}
knitr::include_graphics("D2_1_2g.png")
```

Edit the title of the Legend as shown below.

```{r pressure32, echo=FALSE, fig.cap="Edit Legend Title", out.width = '100%'}
...
```{r pressure34, echo=FALSE, fig.cap="Overview by Event Types", out.width = '100%'}
