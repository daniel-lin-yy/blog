...
```
As such, a new field “employment_status” needs to be created to be consistent with the datasets of the other countries.
...
```{r pressure19, echo=FALSE, fig.cap="Vaccine receptivity and Confidence in vaccine efficacy", out.width = '100%'}
...
```{r pressure20, echo=FALSE, fig.cap="Comparison of vaccine receptivity between age groups", out.width = '100%'}
